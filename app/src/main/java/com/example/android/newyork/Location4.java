...
public class Location4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locations.add(new Location("Name", "(444) 545-4444", "Address"));
        locations.add(new Location("Name", "(444) 444-4444", "Address"));
        locations.add(new Location("Name", "(444) 545-4444", "Address"));
        locations.add(new Location("Name", "(444) 444-4444", "Address"));
        locations.add(new Location("Name", "(444) 545-4444", "Address"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Toast.makeText(Location4.this, "location is: " + position, Toast.LENGTH_SHORT).show();

                int companyBackground;

                switch (position) {
                    case 0:
                        Intent location1Intent = new Intent(Location4.this, LocationDetailActivity.class);
                        ...
                        break;
                    case 1:
                        Intent location2Intent = new Intent(Location4.this, LocationDetailActivity.class);
