...
public class Location3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locations.add(new Location("Name", "(333) 444-4444", "Address"));
        locations.add(new Location("Name", "(333) 545-4444", "Address"));
        locations.add(new Location("Name", "(333) 444-4444", "Address"));
        locations.add(new Location("Name", "(333) 545-4444", "Address"));
        locations.add(new Location("Name", "(333) 444-4444", "Address"));
        locations.add(new Location("Name", "(333) 545-4444", "Address"));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Toast.makeText(Location3.this, "location is: " + position, Toast.LENGTH_SHORT).show();

                int companyBackground;

                switch (position) {
                    case 0:
                        Intent location1Intent = new Intent(Location3.this, LocationDetailActivity.class);
                        ...
                        break;
                    case 1:
                        Intent location2Intent = new Intent(Location3.this, LocationDetailActivity.class);
