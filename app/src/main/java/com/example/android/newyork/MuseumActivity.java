...
public class MuseumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locations.add(new Location(getString(R.string.moma_name), getString(R.string.moma_number),
                getString(R.string.moma_address)));
        locations.add(new Location(getString(R.string.amnh_name), getString(R.string.amnh_number),
                getString(R.string.amnh_address)));
        locations.add(new Location(getString(R.string.guggenheim_name), getString(R.string.guggenheim_number),
                getString(R.string.guggenheim_address)));
        locations.add(new Location(getString(R.string.asm_name), getString(R.string.asm_number),
                getString(R.string.asm_address)));
        locations.add(new Location(getString(R.string.mosex_name), getString(R.string.mosex_number),
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                switch (position) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Intent location2Intent = new Intent(MuseumActivity.this, LocationDetailActivity.class);
                        location2Intent.putExtra("Name", getString(R.string.mosex_name));
                        location2Intent.putExtra("Number", getString(R.string.mosex_number));
                        location2Intent.putExtra("Address", getString(R.string.mosex_address));
                        location2Intent.putExtra("About", getString(R.string.mosex_description));
                        companyBackground = R.drawable.found;
